    ...
    for material in materials:
        ...
        result.append(MaterialMarketInfo(
            ...
            best_sell_location=LocationInfo(
                id=best_sell.location_obj.id,
                name=best_sell.location_obj.name,
                code=best_sell.location_obj.code,
                system=best_sell.location_obj.system,
                planet=best_sell.location_obj.planet,
                location_type=best_sell.location_obj.location_type,
                full_path=best_sell.location_obj.full_location_path,
